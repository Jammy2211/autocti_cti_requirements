...
ci_models = ["serial_x2", "serial_x2", "serial_x2", "serial_x2"]
ci_settings = [
    "settings_ser_front_mask_col_(0,2048)_cr_p10s10d3",
    "settings_ser_front_mask_col_(0,2048)",
    "settings_ser_front_mask_col_(0,2048)",
    "settings_ser_front_mask_col_(0,2048)_cr_p10s10d3",
]
...
for param_index in range(total_params):
    ...
    for image_index in range(total_images):
        ...
        columns_plot = list(map(lambda column: column + jitters[image_index], epers))
...
plt.savefig(plot_path + "/serial_x2_results.png")
plt.show()
